...
## ##########################################################################
## PURPOSE		: Modelsim automation script for gate-level simulation (slow)
## REFERENCES	: 
...
vcom -93 -work work ../postfit_files/rsa_core.vho \
...
vsim -t ps -sdfmax /rsa_core_tb/duv=../postfit_files/rsa_core_vhd.sdo \
...
puts "Starting Slow Model Simulation  ..."
run 25ms
