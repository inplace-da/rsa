...
## ##########################################################################
## PURPOSE		: Modelsim automation script for gate-level simulation (fast)
## REFERENCES	: 
...
vcom -93 -work work ../postfit_files/rsa_core_fast.vho \
...
vsim -t ps -sdfmin /rsa_core_tb/duv=../postfit_files/rsa_core_vhd_fast.sdo \
...
puts "Starting Fast Model Simulation  ..."
run 25ms
